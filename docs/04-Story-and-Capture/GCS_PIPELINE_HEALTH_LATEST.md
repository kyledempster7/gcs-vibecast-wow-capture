# GCS pipeline health — 2026-08-10 15:42

| Check | State | Note |
|-------|-------|------|
| Windows online | 🟢 | verdict=ONLINE_TS+soft_poll_ssh_fresh_1s |
...
| Harvest freshness | 🟡 | `returner-daily-2026-08-09` · day ~40h old · STALE prior day |
